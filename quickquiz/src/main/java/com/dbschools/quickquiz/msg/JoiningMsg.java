...
/**
 * A quiz taker is joining the quiz.
 * 
 * @author David C. Briccetti
 */
public final class JoiningMsg extends AbstractBroadcastMsg {
    private static final long serialVersionUID = -957875184173971674L;
    private final QuizTaker quizTaker;

    public JoiningMsg(QuizTaker quizTaker) {
        super();
