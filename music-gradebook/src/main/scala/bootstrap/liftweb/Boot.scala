...
class Boot {
  def boot {
    ...
    def sitemap = SiteMap(
      ...
      Menu.i("New Instrument")      / "instruments" / "create" >> loggedIn >> Hidden,
      Menu.i("Edit Instrument")     / "instruments" / "edit"   >> loggedIn >> Hidden,
      Menu.i("View Instrument")     / "instruments" / "view"   >> loggedIn >> Hidden,
      Menu.i("Delete Instrument")   / "instruments" / "delete" >> loggedIn >> Hidden,
